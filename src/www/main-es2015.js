...
let AppComponent = class AppComponent {
    constructor(router, push, storage, alertController, diagnostic, iab, platform, splashScreen) {
        this.router = router;
        this.push = push;
    ...
    showView() {
        ...
        const browser = this.iab.create('https://www.roptani.com.bd/', "_self", ab);
        browser.show();
    ...
    initPushNotification() {
        ...
        pushObject.on('registration').subscribe((data) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
/* harmony import */ var _ionic_native_push_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/push/ngx */ "./node_modules/@ionic-native/push/__ivy_ngcc__/ngx/index.js");
...
module.exports = __webpack_require__(/*! /Users/junaidsatti/inapp/src/main.ts */"./src/main.ts");
